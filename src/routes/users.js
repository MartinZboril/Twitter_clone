...
usersRouter.get("/profile", authorized, async (req, res) => {
    res.render("users/profile", { title: 'Profile' })
})

usersRouter.get("/edit-profile", authorized, async (req, res) => {
    res.render("users/edit-profile", { title: 'Edit profile' })
})

usersRouter.post("/edit-profile", authorized, async (req, res) => {
...
usersRouter.get("/change-password", authorized, async (req, res) => {
    res.render("users/change-password", { title: 'Change password' })
})

usersRouter.post("/change-password", authorized, async (req, res) => {
    const id = res.locals.user.id
